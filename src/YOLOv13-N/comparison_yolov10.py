...
features_benchmark = subprocess.run(["/home/gpnpu/Desktop/AI_development/v0.0.rc5/venv_benchmark/bin/python", "benchmark_yolov10.py"], capture_output=True, text=True)
                                                                                                                                                                                                              
# Call script in venv                                                                                                                                                                                                                                                                            
features_v13 = subprocess.run(["/home/gpnpu/Desktop/AI_development/v0.0.rc5/venv/bin/python", "YOLOv13_N.py"], capture_output=True, text=True)
