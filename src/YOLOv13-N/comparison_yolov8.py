...
features_benchmark = subprocess.run(["/home/gpnpu/Desktop/AI_development/v0.0.rc5/venv_benchmark/bin/python", "benchmark_yolov8.py"], capture_output=True, text=True)
