...
def demo(vit_model, test_path, categories, flops_total, all_params):                                                                                                          
...
if __name__ == "__main__":
    ...
    # parameters                                                                                                                       
    all_params = sum(p.numel() for p in vit_model.parameters())                                                                                                                       
    ...
    with torch.no_grad():                                                                                                                             
        for i in range(30):           
            ...
            output = vit_model(dummy_frame)   

    # measure FLOPs stage
    with torch.no_grad():                  
            flops = FlopCountAnalysis(vit_model, dummy_frame)
